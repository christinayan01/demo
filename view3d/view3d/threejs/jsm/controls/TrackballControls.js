...
var TrackballControls = function ( object, domElement ) {
	...
	this.rotateCamera = ( function () {
		...
		var axis = new Vector3(),
			...
			angle;
		var up1 = new Vector3(0,1,0); // yanai add
		...
		return function rotateCamera() {
			...
			if ( angle ) {
				...
				objectUpDirection.copy( _this.object.up ).normalize(); // yanai
				//objectUpDirection.copy( up1 ).normalize(); // yanai
...
var quat = quaternion.setFromUnitVectors( axis, new Vector3( 0, 1, 0 ) );

//				_this.object.up.applyQuaternion( quat ); // yanai out
