...
//{
    ...
    void SerializeTriangle(const std::experimental::filesystem::path& path)
    {
        ...
        Sample2::CreateTriangleResources1(document, bufferBuilder, accessorIdIndices, accessorIdPositions, accessorIdTexCoords);
        Sample2::CreateTriangleEntities1(document, accessorIdIndices, accessorIdPositions, accessorIdTexCoords);
        ...
        else
        {
            ...
            gltfResourceWriter.WriteExternal(pathFile.u8string(), manifest.c_str(), manifest.length()); // yanai // Binary resources have already been written, just need to write the manifest
        }
    }
//}
